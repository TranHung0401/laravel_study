...
<body>
                ...
                <div class="ht-right">
                    ...
                    <div class="lan-selector">
                        <select class="language_drop" name="countries" id="countries" style="width:300px">
                            <option value="yt" data-image="{{asset('front/img/flag-1.jpg')}}" data-imagecss="flag yt" data-title="English">English</option>
                            <option value="yu" data-image="{{asset('front/img/flag-2.jpg')}}" data-imagecss="flag yu" data-title="Bangladesh">Bangladesh</option>
                        </select>
                    </div>
            ...
            <div class="inner-header">
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo">
                            <a href="index">
                                <img src="{{asset('front/img/logo.png')}}" height="25" alt="" >
                            </a>
                        </div>
                    </div>
    ...
    <div class="map spad">
        <div class="container">
            <div class="map-inner">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d501725.4184569199!2d106.36557181096875!3d10.755292855817004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317529292e8d3dd1%3A0xf15f5aad773c112b!2zVGjDoG5oIHBo4buRIEjhu5MgQ2jDrSBNaW5oLCBI4buTIENow60gTWluaCwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1738847145727!5m2!1svi!2s" width="610" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <div class="icon">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="contact-title">
                        <h4>Contact Us</h4>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Id ducimus excepturi unde aspernatur facilis ipsa, dicta deserunt enim dolores, similique optio ipsam non possimus consequatur aperiam quae libero in. Mollitia!</p>
                    </div>
                ...
                <div class="col-lg-6 offset-lg-1">
                    <div class="contact-form">
                        <div class="leave-comment">
                            ...
                            <p>Our staff call back later and answer your questions</p>
                ...
                <div class="col-lg-3">
                    <div class="footer-left">
                        <div class="footer-logo">
                            <a href=""><img src="{{asset('front/img/footer-logo.png')}}" height="25" alt=""></a>
                        </div>
                        <ul>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-text">
                            Copyright <script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="">Code team</a>
                        </div>
