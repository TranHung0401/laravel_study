...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "C1BKA1XV"; //Mã website tại VNPAY
    static $vnp_HashSecret = "ZG0G6V6AM2P2SDO1Q34BS2O49NSTQ77A"; //Chuỗi bí mật
    ...
    public static function vnpay_create_payment(array $data)
    {
        ...
        $vnp_OrderType = 'other'; // Loại hàng hóa: Thực Phẩm - Tiêu Dùng (Xem thêm mã tại: https://sandbox.vnpayment.vn/apis/docs/loai-hang-hoa)
...
//        $vnp_BankCode = $_POST['bank_code'];
        ...
        $inputData = array(
            ...
            "vnp_ExpireDate" => date('YmdHis',strtotime('2025-03-01 23:59:59')),
